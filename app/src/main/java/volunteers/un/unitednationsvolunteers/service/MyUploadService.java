...
import volunteers.un.unitednationsvolunteers.MainActivity;
...
public class MyUploadService extends MyBaseTaskService {
    ...
    private void uploadFromUri(final Uri fileUri) {
        ...
        // [START_EXCLUDE]
        taskStarted();
        showProgressNotification("Uploading your profile picture", 0, 0);
        // [END_EXCLUDE]
        ...
        photoRef.putFile(fileUri).
                addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                        showProgressNotification("Uploading your profile picture",
    ...
    private void showUploadFinishedNotification(@Nullable Uri downloadUrl, @Nullable Uri fileUri) {
        ...
        boolean success = downloadUrl != null;
        String caption = success ? "Uploaded successfully" : "Failed to Upload";
