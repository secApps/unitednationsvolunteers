...
import volunteers.un.unitednationsvolunteers.NewPostActivity;
import volunteers.un.unitednationsvolunteers.PostDetailActivity;
import volunteers.un.unitednationsvolunteers.R;
import volunteers.un.unitednationsvolunteers.viewholders.PostViewHolder;
        ...
        mAdapter = new FirebaseRecyclerAdapter<Post, PostViewHolder>(options) {
            ...
            protected void onBindViewHolder(PostViewHolder viewHolder, int position, final Post model) {
                ...
                if (model.stars.containsKey(getUid())) {
                    viewHolder.starView.setImageResource(R.drawable.ic_star_black_24px);
                } else {
                    viewHolder.starView.setImageResource(R.drawable.ic_star_border_black_24px);
                }
